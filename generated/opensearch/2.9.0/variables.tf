...
variable "advanced_security_options" {
  ...
  type        = any
  default     = { "anonymous_auth_enabled" : false, "enabled" : true }
}
...
variable "log_publishing_options" {
  ...
  type        = any
  default     = [{ "log_type" : "INDEX_SLOW_LOGS" }, { "log_type" : "SEARCH_SLOW_LOGS" }]
}
...
variable "ebs_options" {
  ...
  type        = any
  default     = { "ebs_enabled" : true, "volume_size" : 64, "volume_type" : "gp3" }
}

variable "software_update_options" {
  description = "Software update options for the domain"
  type        = any
  default     = { "auto_software_update_enabled" : true }
}
...
variable "cluster_config" {
  ...
  type        = any
  default     = { "dedicated_master_enabled" : true }
}
