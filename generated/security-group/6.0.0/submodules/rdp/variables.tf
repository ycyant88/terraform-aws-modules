...
variable "preset_ingress_rules" {
  ...
  default = { "rdp-tcp" : { "description" : "Remote desktop protocol", "from_port" : 3389, "ip_protocol" : "tcp", "to_port" : 3389 }, "rdp-udp" : { "description" : "Remote desktop protocol", "from_port" : 3389, "ip_protocol" : "udp", "to_port" : 3389 } }
}
