# AWS HTTPS (port 8443) Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for HTTPS (port 8443).
...
module "https_8443_security_group" {
  ...
  name        = "https-8443"
  description = "Security group for https-8443"
  vpc_id      = "vpc-xxxxxxxx"
...
| ---- | --------- | ------- | -------- | ----------- |
| `https-8443` | 8443 | 8443 | `tcp` | HTTPS |
