...
variable "preset_ingress_rules" {
  ...
  default = { "nomad-http" : { "description" : "Nomad HTTP", "from_port" : 4646, "ip_protocol" : "tcp", "to_port" : 4646 }, "nomad-rpc" : { "description" : "Nomad RPC", "from_port" : 4647, "ip_protocol" : "tcp", "to_port" : 4647 }, "nomad-serf-tcp" : { "description" : "Nomad Serf", "from_port" : 4648, "ip_protocol" : "tcp", "to_port" : 4648 }, "nomad-serf-udp" : { "description" : "Nomad Serf", "from_port" : 4648, "ip_protocol" : "udp", "to_port" : 4648 } }
}
