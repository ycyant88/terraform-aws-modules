...
variable "preset_ingress_rules" {
  ...
  default = { "alertmanager" : { "description" : "Alert Manager", "from_port" : 9093, "ip_protocol" : "tcp", "to_port" : 9093 }, "alertmanager-cluster" : { "description" : "Alert Manager Cluster", "from_port" : 9094, "ip_protocol" : "tcp", "to_port" : 9094 } }
}
