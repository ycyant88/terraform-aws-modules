...
variable "preset_ingress_rules" {
  ...
  default = { "openvpn-https" : { "description" : "OpenVPN HTTPS", "from_port" : 443, "ip_protocol" : "tcp", "to_port" : 443 }, "openvpn-tcp" : { "description" : "OpenVPN", "from_port" : 943, "ip_protocol" : "tcp", "to_port" : 943 }, "openvpn-udp" : { "description" : "OpenVPN", "from_port" : 1194, "ip_protocol" : "udp", "to_port" : 1194 } }
}
