# AWS OpenVPN Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for OpenVPN.
...
| ---- | --------- | ------- | -------- | ----------- |
| `openvpn-https` | 443 | 443 | `tcp` | OpenVPN HTTPS |
