# AWS Elasticsearch Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Elasticsearch.
...
| ---- | --------- | ------- | -------- | ----------- |
| `elasticsearch-java` | 9300 | 9300 | `tcp` | Elasticsearch Java interface |
| `elasticsearch-rest` | 9200 | 9200 | `tcp` | Elasticsearch REST interface |
