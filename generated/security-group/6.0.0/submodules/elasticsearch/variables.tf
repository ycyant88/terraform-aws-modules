...
variable "preset_ingress_rules" {
  ...
  default = { "elasticsearch-java" : { "description" : "Elasticsearch Java interface", "from_port" : 9300, "ip_protocol" : "tcp", "to_port" : 9300 }, "elasticsearch-rest" : { "description" : "Elasticsearch REST interface", "from_port" : 9200, "ip_protocol" : "tcp", "to_port" : 9200 } }
}
