# AWS IPsec (port 4500) Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for IPsec (port 4500).
...
module "ipsec_4500_security_group" {
  ...
  name        = "ipsec-4500"
  description = "Security group for ipsec-4500"
  vpc_id      = "vpc-xxxxxxxx"
...
| ---- | --------- | ------- | -------- | ----------- |
| `ipsec-4500` | 4500 | 4500 | `udp` | IPSEC NAT-T |
