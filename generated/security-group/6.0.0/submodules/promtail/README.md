# AWS Promtail Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Promtail.
...
module "promtail_security_group" {
  ...
  name        = "promtail"
  description = "Security group for promtail"
  vpc_id      = "vpc-xxxxxxxx"
...
| ---- | --------- | ------- | -------- | ----------- |
| `promtail` | 9080 | 9080 | `tcp` | Promtail endpoint |
