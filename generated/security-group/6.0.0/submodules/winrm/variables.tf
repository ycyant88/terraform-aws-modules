...
variable "preset_ingress_rules" {
  ...
  default = { "winrm-http" : { "description" : "WinRM HTTP", "from_port" : 5985, "ip_protocol" : "tcp", "to_port" : 5985 }, "winrm-https" : { "description" : "WinRM HTTPS", "from_port" : 5986, "ip_protocol" : "tcp", "to_port" : 5986 } }
}
