# AWS Carbon Relay Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Carbon Relay.

## Usage

```hcl
module "carbon_relay_security_group" {
  source  = "terraform-aws-modules/security-group/aws//modules/carbon-relay"
  version = "~> 6.0"

  name        = "carbon-relay"
  description = "Security group for carbon-relay"
  vpc_id      = "vpc-xxxxxxxx"
...
| ---- | --------- | ------- | -------- | ----------- |
| `carbon-admin` | 2004 | 2004 | `tcp` | Carbon admin |
| `carbon-gui` | 8081 | 8081 | `tcp` | Carbon GUI |
| `carbon-line-in-tcp` | 2003 | 2003 | `tcp` | Carbon line-in |
| `carbon-line-in-udp` | 2003 | 2003 | `udp` | Carbon line-in |
| `carbon-serializer-tcp` | 2013 | 2013 | `tcp` | Carbon serializer protocol |
| `carbon-serializer-udp` | 2013 | 2013 | `udp` | Carbon serializer protocol |
...
| <a name="input_preset_ingress_rules"></a> [preset\_ingress\_rules](#input\_preset\_ingress\_rules) | Preset ingress rule definitions for this service. Defaults to the curated catalog set; pass `{}` to disable, or override individual entries | <pre>map(object({<br/>    from_port   = number<br/>    to_port     = number<br/>    ip_protocol = string<br/>    description = optional(string)<br/>  }))</pre> | <pre>{<br/>  "carbon-admin": {<br/>    "description": "Carbon admin",<br/>    "from_port": 2004,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 2004<br/>  },<br/>  "carbon-gui": {<br/>    "description": "Carbon GUI",<br/>    "from_port": 8081,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 8081<br/>  },<br/>  "carbon-line-in-tcp": {<br/>    "description": "Carbon line-in",<br/>    "from_port": 2003,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 2003<br/>  },<br/>  "carbon-line-in-udp": {<br/>    "description": "Carbon line-in",<br/>    "from_port": 2003,<br/>    "ip_protocol": "udp",<br/>    "to_port": 2003<br/>  },<br/>  "carbon-serializer-tcp": {<br/>    "description": "Carbon serializer protocol",<br/>    "from_port": 2013,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 2013<br/>  },<br/>  "carbon-serializer-udp": {<br/>    "description": "Carbon serializer protocol",<br/>    "from_port": 2013,<br/>    "ip_protocol": "udp",<br/>    "to_port": 2013<br/>  }<br/>}</pre> | no |
