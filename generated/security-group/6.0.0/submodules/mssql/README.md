# AWS MSSQL Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for MSSQL.
...
| ---- | --------- | ------- | -------- | ----------- |
| `mssql-analytics` | 2383 | 2383 | `tcp` | MSSQL Analytics |
| `mssql-broker` | 4022 | 4022 | `tcp` | MSSQL Broker |
| `mssql-browser` | 1434 | 1434 | `udp` | MSSQL Browser |
| `mssql-server` | 1433 | 1433 | `tcp` | MSSQL Server |
...
| <a name="input_preset_ingress_rules"></a> [preset\_ingress\_rules](#input\_preset\_ingress\_rules) | Preset ingress rule definitions for this service. Defaults to the curated catalog set; pass `{}` to disable, or override individual entries | <pre>map(object({<br/>    from_port   = number<br/>    to_port     = number<br/>    ip_protocol = string<br/>    description = optional(string)<br/>  }))</pre> | <pre>{<br/>  "mssql-analytics": {<br/>    "description": "MSSQL Analytics",<br/>    "from_port": 2383,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 2383<br/>  },<br/>  "mssql-broker": {<br/>    "description": "MSSQL Broker",<br/>    "from_port": 4022,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 4022<br/>  },<br/>  "mssql-browser": {<br/>    "description": "MSSQL Browser",<br/>    "from_port": 1434,<br/>    "ip_protocol": "udp",<br/>    "to_port": 1434<br/>  },<br/>  "mssql-server": {<br/>    "description": "MSSQL Server",<br/>    "from_port": 1433,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 1433<br/>  }<br/>}</pre> | no |
