...
variable "preset_ingress_rules" {
  ...
  default = { "etcd-client" : { "description" : "Etcd Client", "from_port" : 2379, "ip_protocol" : "tcp", "to_port" : 2379 }, "etcd-peer" : { "description" : "Etcd Peer", "from_port" : 2380, "ip_protocol" : "tcp", "to_port" : 2380 } }
}
