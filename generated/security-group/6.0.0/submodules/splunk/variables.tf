...
variable "preset_ingress_rules" {
  ...
  default = { "splunk-hec" : { "description" : "Splunk HEC", "from_port" : 8088, "ip_protocol" : "tcp", "to_port" : 8088 }, "splunk-indexer" : { "description" : "Splunk indexer", "from_port" : 9997, "ip_protocol" : "tcp", "to_port" : 9997 }, "splunk-splunkd" : { "description" : "Splunkd", "from_port" : 8089, "ip_protocol" : "tcp", "to_port" : 8089 }, "splunk-web" : { "description" : "Splunk Web", "from_port" : 8000, "ip_protocol" : "tcp", "to_port" : 8000 } }
}
