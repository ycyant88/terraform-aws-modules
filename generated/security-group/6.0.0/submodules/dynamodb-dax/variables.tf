...
variable "preset_ingress_rules" {
  ...
  default = { "dax-encrypted" : { "description" : "DAX Cluster encrypted", "from_port" : 9111, "ip_protocol" : "tcp", "to_port" : 9111 }, "dax-unencrypted" : { "description" : "DAX Cluster unencrypted", "from_port" : 8111, "ip_protocol" : "tcp", "to_port" : 8111 } }
}
