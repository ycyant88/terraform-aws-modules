...
variable "preset_ingress_rules" {
  ...
  default = { "zabbix-agent" : { "description" : "Zabbix Agent", "from_port" : 10050, "ip_protocol" : "tcp", "to_port" : 10050 }, "zabbix-proxy" : { "description" : "Zabbix Proxy", "from_port" : 10051, "ip_protocol" : "tcp", "to_port" : 10051 }, "zabbix-server" : { "description" : "Zabbix Server", "from_port" : 10051, "ip_protocol" : "tcp", "to_port" : 10051 } }
}
