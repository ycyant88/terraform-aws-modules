...
variable "preset_ingress_rules" {
  ...
  default = { "storm-nimbus" : { "description" : "Nimbus", "from_port" : 6627, "ip_protocol" : "tcp", "to_port" : 6627 }, "storm-supervisor" : { "description" : "Supervisor", "from_port" : 6700, "ip_protocol" : "tcp", "to_port" : 6703 }, "storm-ui" : { "description" : "Storm UI", "from_port" : 8080, "ip_protocol" : "tcp", "to_port" : 8080 } }
}
