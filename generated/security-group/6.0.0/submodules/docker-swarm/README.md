# AWS Docker Swarm Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Docker Swarm.
...
| ---- | --------- | ------- | -------- | ----------- |
| `docker-swarm-management` | 2377 | 2377 | `tcp` | Docker Swarm cluster management |
| `docker-swarm-node-tcp` | 7946 | 7946 | `tcp` | Docker Swarm node |
| `docker-swarm-node-udp` | 7946 | 7946 | `udp` | Docker Swarm node |
| `docker-swarm-overlay` | 4789 | 4789 | `udp` | Docker Swarm Overlay Network Traffic |
...
| <a name="input_preset_ingress_rules"></a> [preset\_ingress\_rules](#input\_preset\_ingress\_rules) | Preset ingress rule definitions for this service. Defaults to the curated catalog set; pass `{}` to disable, or override individual entries | <pre>map(object({<br/>    from_port   = number<br/>    to_port     = number<br/>    ip_protocol = string<br/>    description = optional(string)<br/>  }))</pre> | <pre>{<br/>  "docker-swarm-management": {<br/>    "description": "Docker Swarm cluster management",<br/>    "from_port": 2377,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 2377<br/>  },<br/>  "docker-swarm-node-tcp": {<br/>    "description": "Docker Swarm node",<br/>    "from_port": 7946,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 7946<br/>  },<br/>  "docker-swarm-node-udp": {<br/>    "description": "Docker Swarm node",<br/>    "from_port": 7946,<br/>    "ip_protocol": "udp",<br/>    "to_port": 7946<br/>  },<br/>  "docker-swarm-overlay": {<br/>    "description": "Docker Swarm Overlay Network Traffic",<br/>    "from_port": 4789,<br/>    "ip_protocol": "udp",<br/>    "to_port": 4789<br/>  }<br/>}</pre> | no |
