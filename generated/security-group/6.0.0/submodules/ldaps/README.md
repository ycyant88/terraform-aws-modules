# AWS LDAPS Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for LDAPS.
...
module "ldaps_security_group" {
  ...
  name        = "ldaps"
  description = "Security group for ldaps"
  vpc_id      = "vpc-xxxxxxxx"
