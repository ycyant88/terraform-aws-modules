...
variable "preset_ingress_rules" {
  ...
  default = { "loki" : { "description" : "Grafana Loki endpoint", "from_port" : 3100, "ip_protocol" : "tcp", "to_port" : 3100 }, "loki-grpc" : { "description" : "Grafana Loki gRPC", "from_port" : 9095, "ip_protocol" : "tcp", "to_port" : 9095 } }
}
