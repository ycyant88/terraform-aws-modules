...
variable "preset_ingress_rules" {
  ...
  default = { "prometheus" : { "description" : "Prometheus", "from_port" : 9090, "ip_protocol" : "tcp", "to_port" : 9090 }, "prometheus-node-exporter" : { "description" : "Prometheus Node Exporter", "from_port" : 9100, "ip_protocol" : "tcp", "to_port" : 9100 }, "prometheus-pushgateway" : { "description" : "Prometheus Pushgateway", "from_port" : 9091, "ip_protocol" : "tcp", "to_port" : 9091 } }
}
