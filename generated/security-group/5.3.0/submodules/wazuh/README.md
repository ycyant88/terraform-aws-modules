...
| <a name="input_auto_ingress_rules"></a> [auto\_ingress\_rules](#input\_auto\_ingress\_rules) | List of ingress rules to add automatically | `list(string)` | <pre>[<br/>  "wazuh-server-agent-connection-tcp",<br/>  "wazuh-server-agent-connection-udp",<br/>  "wazuh-server-agent-enrollment",<br/>  "wazuh-server-agent-cluster-daemon",<br/>  "wazuh-server-syslog-collector-tcp",<br/>  "wazuh-server-syslog-collector-udp",<br/>  "wazuh-server-restful-api",<br/>  "wazuh-indexer-restful-api",<br/>  "wazuh-dashboard"<br/>]</pre> | no |
