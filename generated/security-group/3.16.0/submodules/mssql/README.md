...
| auto\_ingress\_rules | List of ingress rules to add automatically | `list(string)` | <pre>[<br>  "mssql-tcp",<br>  "mssql-udp",<br>  "mssql-analytics-tcp",<br>  "mssql-broker-tcp"<br>]</pre> | no |
