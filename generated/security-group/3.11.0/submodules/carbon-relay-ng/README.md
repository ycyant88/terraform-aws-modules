...
| auto\_ingress\_rules | List of ingress rules to add automatically | `list(string)` | <pre>[<br>  "carbon-line-in-tcp",<br>  "carbon-line-in-udp",<br>  "carbon-pickle-tcp",<br>  "carbon-pickle-udp",<br>  "carbon-gui-udp"<br>]</pre> | no |
