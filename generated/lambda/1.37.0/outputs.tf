...
output "this_lambda_event_source_mapping_state" {
  value       = module.lambda.this_lambda_event_source_mapping_state
...
output "this_lambda_event_source_mapping_state_transition_reason" {
  value       = module.lambda.this_lambda_event_source_mapping_state_transition_reason
...
output "this_lambda_event_source_mapping_uuid" {
  value       = module.lambda.this_lambda_event_source_mapping_uuid
...
output "this_lambda_event_source_mapping_function_arn" {
  value       = module.lambda.this_lambda_event_source_mapping_function_arn
