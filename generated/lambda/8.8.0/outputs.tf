...
output "lambda_function_code_sha256" {
  value       = module.lambda.lambda_function_code_sha256
...
output "lambda_layer_source_code_hash" {
  value       = module.lambda.lambda_layer_source_code_hash
...
output "lambda_function_arn_static" {
  value       = module.lambda.lambda_function_arn_static
...
output "lambda_layer_code_sha256" {
  value       = module.lambda.lambda_layer_code_sha256
