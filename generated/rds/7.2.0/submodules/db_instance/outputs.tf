output "db_instance_availability_zone" {
  value       = module.rds_db_instance.db_instance_availability_zone
...
output "db_listener_endpoint" {
  value       = module.rds_db_instance.db_listener_endpoint
  description = "Specifies the listener connection endpoint for SQL Server Always On"
}

output "db_instance_hosted_zone_id" {
  value       = module.rds_db_instance.db_instance_hosted_zone_id
  description = "The canonical hosted zone ID of the DB instance (to be used in a Route 53 Alias record)"
}

output "db_instance_resource_id" {
  value       = module.rds_db_instance.db_instance_resource_id
...
output "db_instance_ca_cert_identifier" {
  value       = module.rds_db_instance.db_instance_ca_cert_identifier
...
output "db_instance_identifier" {
  value       = module.rds_db_instance.db_instance_identifier
  description = "The RDS instance identifier"
}

output "db_instance_domain_dns_ips" {
  value       = module.rds_db_instance.db_instance_domain_dns_ips
...
output "db_instance_upgrade_rollout_order" {
  value       = module.rds_db_instance.db_instance_upgrade_rollout_order
...
output "db_instance_engine" {
  value       = module.rds_db_instance.db_instance_engine
...
output "db_instance_domain_auth_secret_arn" {
  value       = module.rds_db_instance.db_instance_domain_auth_secret_arn
...
output "db_instance_domain_ou" {
  value       = module.rds_db_instance.db_instance_domain_ou
  description = "The self managed Active Directory organizational unit for your DB instance to join"
}

output "db_instance_master_user_secret_arn" {
  value       = module.rds_db_instance.db_instance_master_user_secret_arn
  description = "The ARN of the master user secret (Only available when manage_master_user_password is set to true)"
}

output "db_instance_cloudwatch_log_groups" {
  value       = module.rds_db_instance.db_instance_cloudwatch_log_groups
  description = "Map of CloudWatch log groups created and their attributes"
}

output "db_instance_secretsmanager_secret_rotation_enabled" {
  value       = module.rds_db_instance.db_instance_secretsmanager_secret_rotation_enabled
...
output "db_instance_engine_version_actual" {
  value       = module.rds_db_instance.db_instance_engine_version_actual
  description = "The running version of the database"
}

output "db_instance_status" {
  value       = module.rds_db_instance.db_instance_status
...
output "db_instance_domain" {
  value       = module.rds_db_instance.db_instance_domain
  description = "The ID of the Directory Service Active Directory domain the instance is joined to"
}

output "db_instance_domain_fqdn" {
  value       = module.rds_db_instance.db_instance_domain_fqdn
  description = "The fully qualified domain name (FQDN) of an self managed Active Directory domain"
}

output "db_instance_domain_iam_role_name" {
  value       = module.rds_db_instance.db_instance_domain_iam_role_name
