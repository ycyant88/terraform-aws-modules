...
output "vpc_endpoint_sagemaker_notebook_id" {
  value       = module.vpc.vpc_endpoint_sagemaker_notebook_id
...
output "vpc_endpoint_sagemaker_notebook_network_interface_ids" {
  value       = module.vpc.vpc_endpoint_sagemaker_notebook_network_interface_ids
...
output "vpc_endpoint_sagemaker_notebook_dns_entry" {
  value       = module.vpc.vpc_endpoint_sagemaker_notebook_dns_entry
