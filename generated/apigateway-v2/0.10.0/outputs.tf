...
output "this_apigatewayv2_domain_name_target_domain_name" {
  value       = module.apigateway-v2.this_apigatewayv2_domain_name_target_domain_name
  description = "The target domain name"
}

output "this_apigatewayv2_vpc_link_arn" {
  value       = module.apigateway-v2.this_apigatewayv2_vpc_link_arn
...
output "this_apigatewayv2_vpc_link_id" {
  value       = module.apigateway-v2.this_apigatewayv2_vpc_link_id
...
output "this_apigatewayv2_domain_name_hosted_zone_id" {
  value       = module.apigateway-v2.this_apigatewayv2_domain_name_hosted_zone_id
