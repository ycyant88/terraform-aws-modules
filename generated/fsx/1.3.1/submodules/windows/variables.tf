...
variable "security_group_egress_rules" {
  ...
  type        = any
  default     = { "ipv4" : { "cidr_ipv4" : "0.0.0.0/0", "description" : "Allow all outbound traffic by default", "ip_protocol" : "-1" }, "ipv6" : { "cidr_ipv6" : "::/0", "description" : "Allow all outbound traffic by default", "ip_protocol" : "-1" } }
}
...
variable "audit_log_configuration" {
  ...
  type        = any
  default     = { "file_access_audit_log_level" : "FAILURE_ONLY", "file_share_access_audit_log_level" : "FAILURE_ONLY" }
}
