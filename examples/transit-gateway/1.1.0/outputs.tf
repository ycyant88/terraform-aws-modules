...
output "this_ec2_transit_gateway_route_ids" {
  value       = module.transit-gateway.this_ec2_transit_gateway_route_ids
...
output "this_ec2_transit_gateway_route_table_association" {
  value       = module.transit-gateway.this_ec2_transit_gateway_route_table_association
...
output "this_ec2_transit_gateway_route_table_association_ids" {
  value       = module.transit-gateway.this_ec2_transit_gateway_route_table_association_ids
...
output "this_ec2_transit_gateway_route_table_propagation" {
  value       = module.transit-gateway.this_ec2_transit_gateway_route_table_propagation
...
output "this_ec2_transit_gateway_route_table_propagation_ids" {
  value       = module.transit-gateway.this_ec2_transit_gateway_route_table_propagation_ids
