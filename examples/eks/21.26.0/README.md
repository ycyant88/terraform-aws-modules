...
| <a name="input_enable_auto_mode_block_storage_policy_v2"></a> [enable\_auto\_mode\_block\_storage\_policy\_v2](#input\_enable\_auto\_mode\_block\_storage\_policy\_v2) | Determines whether to use the v2 AmazonEKSBlockStoragePolicy instead of the legacy v1 policy for the EKS Auto Mode cluster IAM role. Defaults to false (uses v1). | `bool` | `false` | no |
