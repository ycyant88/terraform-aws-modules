output "autoscaling_policies" {
  value       = module.ecs.autoscaling_policies
  description = "Map of autoscaling policies and their attributes"
}

output "autoscaling_scheduled_actions" {
  value       = module.ecs.autoscaling_scheduled_actions
  description = "Map of autoscaling scheduled actions and their attributes"
}

output "container_definitions" {
  value       = module.ecs.container_definitions
...
output "iam_role_name" {
  value       = module.ecs.iam_role_name
  description = "Service IAM role name"
}

output "iam_role_unique_id" {
  value       = module.ecs.iam_role_unique_id
...
output "security_group_arn" {
  value       = module.ecs.security_group_arn
...
output "task_definition_family_revision" {
  value       = module.ecs.task_definition_family_revision
