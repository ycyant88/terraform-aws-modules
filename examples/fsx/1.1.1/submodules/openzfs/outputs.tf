output "child_volumes_snapshots" {
  value       = module.fsx.child_volumes_snapshots
...
output "file_system_endpoint_ip_address" {
  value       = module.fsx.file_system_endpoint_ip_address
