output "access_key_encrypted_secret" {
  value       = module.iam.access_key_encrypted_secret
  description = "The encrypted secret, base64 encoded"
}

output "access_key_encrypted_ses_smtp_password_v4" {
  value       = module.iam.access_key_encrypted_ses_smtp_password_v4
...
output "access_key_fingerprint" {
  value       = module.iam.access_key_fingerprint
...
output "access_key_ses_smtp_password_v4" {
  value       = module.iam.access_key_ses_smtp_password_v4
...
output "access_key_status" {
  value       = module.iam.access_key_status
...
output "login_profile_encrypted_password" {
  value       = module.iam.login_profile_encrypted_password
  description = "The encrypted password, base64 encoded"
}

output "login_profile_key_fingerprint" {
  value       = module.iam.login_profile_key_fingerprint
  description = "The fingerprint of the PGP key used to encrypt the password"
}

output "login_profile_password" {
  value       = module.iam.login_profile_password
...
output "ssh_key_fingerprint" {
  value       = module.iam.ssh_key_fingerprint
  description = "The MD5 message digest of the SSH public key"
}

output "ssh_key_public_key_id" {
  value       = module.iam.ssh_key_public_key_id
