output "caller_identity_account_id" {
  value       = module.iam.caller_identity_account_id
  description = "The AWS Account ID number of the account that owns or contains the calling entity"
}

output "caller_identity_arn" {
  value       = module.iam.caller_identity_arn
  description = "The AWS ARN associated with the calling entity"
}

output "caller_identity_user_id" {
  value       = module.iam.caller_identity_user_id
  description = "The unique identifier of the calling entity"
}

output "iam_account_password_policy_expire_passwords" {
  value       = module.iam.iam_account_password_policy_expire_passwords
