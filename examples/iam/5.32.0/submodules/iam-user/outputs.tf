output "iam_access_key_encrypted_secret" {
  value       = module.iam.iam_access_key_encrypted_secret
  description = "The encrypted secret, base64 encoded"
}

output "iam_access_key_encrypted_ses_smtp_password_v4" {
  value       = module.iam.iam_access_key_encrypted_ses_smtp_password_v4
...
output "iam_access_key_key_fingerprint" {
  value       = module.iam.iam_access_key_key_fingerprint
...
output "iam_access_key_ses_smtp_password_v4" {
  value       = module.iam.iam_access_key_ses_smtp_password_v4
...
output "iam_access_key_status" {
  value       = module.iam.iam_access_key_status
...
output "iam_user_login_profile_encrypted_password" {
  value       = module.iam.iam_user_login_profile_encrypted_password
  description = "The encrypted password, base64 encoded"
}

output "iam_user_login_profile_key_fingerprint" {
  value       = module.iam.iam_user_login_profile_key_fingerprint
...
output "iam_user_ssh_key_fingerprint" {
  value       = module.iam.iam_user_ssh_key_fingerprint
  description = "The MD5 message digest of the SSH public key"
}

output "iam_user_ssh_key_ssh_public_key_id" {
  value       = module.iam.iam_user_ssh_key_ssh_public_key_id
  description = "The unique identifier for the SSH public key"
}

output "iam_user_unique_id" {
  value       = module.iam.iam_user_unique_id
...
output "keybase_ses_smtp_password_v4_decrypt_command" {
  value       = module.iam.keybase_ses_smtp_password_v4_decrypt_command
  description = "Decrypt SES SMTP password command"
}

output "keybase_ses_smtp_password_v4_pgp_message" {
  value       = module.iam.keybase_ses_smtp_password_v4_pgp_message
