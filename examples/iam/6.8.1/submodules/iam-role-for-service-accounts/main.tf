...
module "iam_iam-role-for-service-accounts" {
  ...
  load_balancer_controller_aga_policy_description                 = var.load_balancer_controller_aga_policy_description
  load_balancer_controller_aga_policy_name                        = var.load_balancer_controller_aga_policy_name
