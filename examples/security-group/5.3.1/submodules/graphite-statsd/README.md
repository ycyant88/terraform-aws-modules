...
| <a name="input_auto_ingress_rules"></a> [auto\_ingress\_rules](#input\_auto\_ingress\_rules) | List of ingress rules to add automatically | `list(string)` | <pre>[<br/>  "graphite-webui",<br/>  "graphite-2003-tcp",<br/>  "graphite-2004-tcp",<br/>  "graphite-2023-tcp",<br/>  "graphite-2024-tcp",<br/>  "graphite-8080-tcp",<br/>  "graphite-8125-tcp",<br/>  "graphite-8125-udp",<br/>  "graphite-8126-tcp"<br/>]</pre> | no |
