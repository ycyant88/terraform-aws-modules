...
| auto\_ingress\_rules | List of ingress rules to add automatically | `list(string)` | <pre>[<br>  "mongodb-27017-tcp",<br>  "mongodb-27018-tcp",<br>  "mongodb-27019-tcp"<br>]</pre> | no |
