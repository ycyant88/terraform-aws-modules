# AWS Kafka Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Kafka.
...
| ---- | --------- | ------- | -------- | ----------- |
| `kafka-broker` | 9092 | 9092 | `tcp` | Kafka PLAINTEXT broker |
| `kafka-broker-sasl-iam` | 9098 | 9098 | `tcp` | Kafka SASL/IAM broker (MSK) |
| `kafka-broker-sasl-iam-public` | 9198 | 9198 | `tcp` | Kafka SASL/IAM public broker (MSK) |
| `kafka-broker-sasl-scram` | 9096 | 9096 | `tcp` | Kafka SASL/SCRAM broker (MSK) |
| `kafka-broker-sasl-scram-public` | 9196 | 9196 | `tcp` | Kafka SASL/SCRAM public broker (MSK) |
| `kafka-broker-tls` | 9094 | 9094 | `tcp` | Kafka TLS broker |
| `kafka-broker-tls-public` | 9194 | 9194 | `tcp` | Kafka TLS public broker (MSK) |
| `kafka-jmx-exporter` | 11001 | 11001 | `tcp` | Kafka JMX Exporter |
| `kafka-node-exporter` | 11002 | 11002 | `tcp` | Kafka Node Exporter |
...
| <a name="input_preset_ingress_rules"></a> [preset\_ingress\_rules](#input\_preset\_ingress\_rules) | Preset ingress rule definitions for this service. Defaults to the curated catalog set; pass `{}` to disable, or override individual entries | <pre>map(object({<br/>    from_port   = number<br/>    to_port     = number<br/>    ip_protocol = string<br/>    description = optional(string)<br/>  }))</pre> | <pre>{<br/>  "kafka-broker": {<br/>    "description": "Kafka PLAINTEXT broker",<br/>    "from_port": 9092,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 9092<br/>  },<br/>  "kafka-broker-sasl-iam": {<br/>    "description": "Kafka SASL/IAM broker (MSK)",<br/>    "from_port": 9098,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 9098<br/>  },<br/>  "kafka-broker-sasl-iam-public": {<br/>    "description": "Kafka SASL/IAM public broker (MSK)",<br/>    "from_port": 9198,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 9198<br/>  },<br/>  "kafka-broker-sasl-scram": {<br/>    "description": "Kafka SASL/SCRAM broker (MSK)",<br/>    "from_port": 9096,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 9096<br/>  },<br/>  "kafka-broker-sasl-scram-public": {<br/>    "description": "Kafka SASL/SCRAM public broker (MSK)",<br/>    "from_port": 9196,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 9196<br/>  },<br/>  "kafka-broker-tls": {<br/>    "description": "Kafka TLS broker",<br/>    "from_port": 9094,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 9094<br/>  },<br/>  "kafka-broker-tls-public": {<br/>    "description": "Kafka TLS public broker (MSK)",<br/>    "from_port": 9194,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 9194<br/>  },<br/>  "kafka-jmx-exporter": {<br/>    "description": "Kafka JMX Exporter",<br/>    "from_port": 11001,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 11001<br/>  },<br/>  "kafka-node-exporter": {<br/>    "description": "Kafka Node Exporter",<br/>    "from_port": 11002,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 11002<br/>  }<br/>}</pre> | no |
