# AWS Loki Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Loki.
...
| ---- | --------- | ------- | -------- | ----------- |
| `loki` | 3100 | 3100 | `tcp` | Grafana Loki endpoint |
| `loki-grpc` | 9095 | 9095 | `tcp` | Grafana Loki gRPC |
