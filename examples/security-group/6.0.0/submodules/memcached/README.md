# AWS Memcached Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Memcached.
...
| ---- | --------- | ------- | -------- | ----------- |
| `memcached` | 11211 | 11211 | `tcp` | Memcached |
