# AWS Zabbix Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Zabbix.
...
| <a name="input_preset_ingress_rules"></a> [preset\_ingress\_rules](#input\_preset\_ingress\_rules) | Preset ingress rule definitions for this service. Defaults to the curated catalog set; pass `{}` to disable, or override individual entries | <pre>map(object({<br/>    from_port   = number<br/>    to_port     = number<br/>    ip_protocol = string<br/>    description = optional(string)<br/>  }))</pre> | <pre>{<br/>  "zabbix-agent": {<br/>    "description": "Zabbix Agent",<br/>    "from_port": 10050,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 10050<br/>  },<br/>  "zabbix-proxy": {<br/>    "description": "Zabbix Proxy",<br/>    "from_port": 10051,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 10051<br/>  },<br/>  "zabbix-server": {<br/>    "description": "Zabbix Server",<br/>    "from_port": 10051,<br/>    "ip_protocol": "tcp",<br/>    "to_port": 10051<br/>  }<br/>}</pre> | no |
