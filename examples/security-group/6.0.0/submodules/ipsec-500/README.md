# AWS IPsec (port 500) Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for IPsec (port 500).
...
module "ipsec_500_security_group" {
  ...
  name        = "ipsec-500"
  description = "Security group for ipsec-500"
  vpc_id      = "vpc-xxxxxxxx"
...
| ---- | --------- | ------- | -------- | ----------- |
| `ipsec-500` | 500 | 500 | `udp` | IPSEC ISAKMP |
