# AWS Puppet Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Puppet.
...
module "puppet_security_group" {
  ...
  name        = "puppet"
  description = "Security group for puppet"
  vpc_id      = "vpc-xxxxxxxx"
...
| ---- | --------- | ------- | -------- | ----------- |
| `puppet` | 8140 | 8140 | `tcp` | Puppet |
| `puppetdb` | 8081 | 8081 | `tcp` | PuppetDB |
