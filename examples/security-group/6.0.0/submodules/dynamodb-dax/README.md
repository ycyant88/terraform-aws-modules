# AWS DynamoDB DAX Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for DynamoDB DAX.

## Usage

```hcl
module "dynamodb_dax_security_group" {
...
| ---- | --------- | ------- | -------- | ----------- |
| `dax-encrypted` | 9111 | 9111 | `tcp` | DAX Cluster encrypted |
| `dax-unencrypted` | 8111 | 8111 | `tcp` | DAX Cluster unencrypted |
