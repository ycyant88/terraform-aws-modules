# AWS Oracle Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Oracle.

## Usage

```hcl
module "oracle_security_group" {
