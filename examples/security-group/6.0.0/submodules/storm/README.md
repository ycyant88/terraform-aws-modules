# AWS Storm Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Storm.
...
module "storm_security_group" {
  ...
  name        = "storm"
  description = "Security group for storm"
  vpc_id      = "vpc-xxxxxxxx"
...
| ---- | --------- | ------- | -------- | ----------- |
| `storm-nimbus` | 6627 | 6627 | `tcp` | Nimbus |
| `storm-supervisor` | 6700 | 6703 | `tcp` | Supervisor |
| `storm-ui` | 8080 | 8080 | `tcp` | Storm UI |
