# AWS RDP Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for RDP.
...
| ---- | --------- | ------- | -------- | ----------- |
| `rdp-tcp` | 3389 | 3389 | `tcp` | Remote desktop protocol |
| `rdp-udp` | 3389 | 3389 | `udp` | Remote desktop protocol |
