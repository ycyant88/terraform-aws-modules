# AWS Grafana Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Grafana.
...
| ---- | --------- | ------- | -------- | ----------- |
| `grafana` | 3000 | 3000 | `tcp` | Grafana Dashboard |
