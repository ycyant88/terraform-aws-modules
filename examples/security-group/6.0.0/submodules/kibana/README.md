# AWS Kibana Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for Kibana.
...
| ---- | --------- | ------- | -------- | ----------- |
| `kibana` | 5601 | 5601 | `tcp` | Kibana Web Interface |
