# AWS SaltStack Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for SaltStack.

## Usage

```hcl
module "saltstack_security_group" {
  source  = "terraform-aws-modules/security-group/aws//modules/saltstack"
  version = "~> 6.0"

  name        = "saltstack"
  description = "Security group for saltstack"
  vpc_id      = "vpc-xxxxxxxx"
...
| ---- | --------- | ------- | -------- | ----------- |
| `saltstack` | 4505 | 4506 | `tcp` | SaltStack |
