# AWS JMX Security Group Terraform Module

Terraform module which creates a pre-configured AWS security group for JMX.

## Usage

```hcl
module "jmx_security_group" {
  source  = "terraform-aws-modules/security-group/aws//modules/jmx"
  version = "~> 6.0"

  name        = "jmx"
  description = "Security group for jmx"
  vpc_id      = "vpc-xxxxxxxx"
